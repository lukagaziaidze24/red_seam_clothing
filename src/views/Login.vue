    ...
    head() {
        return {
            ...
            meta: [
                {
                    name: 'description',
                    content: 'Login to the %siteName and get the best online shopping experience.'
                },
                {
                    name: 'robots',
                ...
                {
                    property: 'og:url',
                    content: 'https://lukagaziaidze24.github.io/red_seam_clothing/#/login'
                },
                {
                    property: 'og:title',
                    content: 'login %separator %siteName'
                },
                {
